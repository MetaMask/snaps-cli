 ...
 * @returns {NodeJS.WritableStream} - The stream
 */
 ...
 *
 * @param {NodeJS.WritableStream} stream - The write stream
 ...
 */
async function writeError(prefix: string, msg: string, err: Error, destFilePath?: string) {
